...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        self.groupBox_maj = QtWidgets.QGroupBox(parent=self.tab_deleteEFK)
        ...
        self.groupBox_UninstallEFK = QtWidgets.QGroupBox(parent=self.tab_deleteEFK)
        ...
        self.pushButton_UninstallEFK.setGeometry(QtCore.QRect(15, 140, 261, 51))
        font = QtGui.QFont()
        font.setFamily("Bender")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/gfx/gfx/france.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.radioButton_France.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/gfx/gfx/royaumeunis.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.radioButton_English.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/gfx/gfx/Twitch-logo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.commandLinkButton_Twitch.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/gfx/gfx/youtube.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/gfx/gfx/discord.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.commandLinkButton_Discord.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/gfx/gfx/Steam_Icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.commandLinkButton_STEAM.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/gfx/gfx/pz.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_RunPZ.setIcon(icon9)
    ...
    def retranslateUi(self, Fenetre_Principale):
        ...
        self.label_UninstallEFK.setText(_translate("Fenetre_Principale", "<html><head/><body><p><span style=\" font-weight:700; text-decoration: underline;\">Pour desintaller EFK :<br/></span><span style=\" font-weight:700;\"/>1 - Quitter Project Zomboid<br/> 2 - Se Desabonner à la <a href=\"https://steamcommunity.com/workshop/filedetails/?id=3048855836\"><span style=\" text-decoration: underline; color:#0000ff;\">collection Steam EFK<br/></span></a><a href=\"https://steamcommunity.com/workshop/filedetails/?id=3048855836\"><span style=\" color:#0000ff;\"/></a>3 - Cliquer sur <span style=\" font-weight:700;\">Desinstaller EFK<br/></span>4 - Une fois le EFK Launcher Fermé<br/>Supprimer votre repertoire local du <span style=\" font-weight:700;\">EFK Launcher</span></p><p><span style=\" font-weight:700;\"><br/></span></p></body></html>"))
        self.tabWidget_FenetrePrincipale.setTabText(self.tabWidget_FenetrePrincipale.indexOf(self.tab_deleteEFK), _translate("Fenetre_Principale", "Options"))
