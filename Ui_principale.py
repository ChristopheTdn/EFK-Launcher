...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        Fenetre_Principale.resize(615, 602)
        icon = QtGui.QIcon()
        ...
        self.tabWidget_FenetrePrincipale.setGeometry(QtCore.QRect(20, 255, 581, 261))
        ...
        self.label_difficultSTD.setGeometry(QtCore.QRect(235, 25, 111, 16))
        self.label_difficultSTD.setObjectName("label_difficultSTD")
        self.label_difficultHARD = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_difficultHARD.setGeometry(QtCore.QRect(390, 25, 111, 16))
        ...
        self.label_IconStatus_difficultSTD.setGeometry(QtCore.QRect(265, 45, 31, 31))
        ...
        self.label_IconStatus_difficultHARD.setGeometry(QtCore.QRect(420, 40, 31, 31))
        ...
        self.textEdit_Log.setGeometry(QtCore.QRect(10, 10, 546, 211))
        self.textEdit_Log.setObjectName("textEdit_Log")
        self.tabWidget_FenetrePrincipale.addTab(self.tab_Log, "")
        self.groupBox = QtWidgets.QGroupBox(parent=self.centralWidget)
        self.groupBox.setGeometry(QtCore.QRect(20, 175, 581, 76))
        self.groupBox.setObjectName("groupBox")
        self.lineEdit_ProfilPZ = QtWidgets.QLineEdit(parent=self.groupBox)
        self.lineEdit_ProfilPZ.setGeometry(QtCore.QRect(85, 20, 351, 21))
        font = QtGui.QFont()
        ...
        self.label_IconStatus_RepertoireSaveGame.setGeometry(QtCore.QRect(445, 40, 31, 31))
        ...
        self.lineEdit_RepertoireSaveGame.setGeometry(QtCore.QRect(85, 45, 351, 21))
        font = QtGui.QFont()
        font.setKerning(True)
        ...
        self.label_IconStatus_ProfilPZ.setGeometry(QtCore.QRect(445, 15, 31, 31))
        ...
        self.label_4.setGeometry(QtCore.QRect(0, 20, 81, 20))
        ...
        self.label_5.setGeometry(QtCore.QRect(0, 45, 81, 20))
        ...
        self.pushButton_SetRepertoireSaveGame.setGeometry(QtCore.QRect(490, 45, 71, 24))
        ...
        self.label_Danger.setGeometry(QtCore.QRect(320, 540, 51, 46))
        ...
        self.pushButton_WIPE.setGeometry(QtCore.QRect(95, 540, 166, 41))
        font = QtGui.QFont()
        ...
        self.radioButton_France.setGeometry(QtCore.QRect(435, 20, 106, 26))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/gfx/gfx/france.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.radioButton_France.setIcon(icon1)
        ...
        self.radioButton_English.setGeometry(QtCore.QRect(435, 50, 96, 26))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/gfx/gfx/royaumeunis.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.radioButton_English.setIcon(icon2)
        ...
        self.label_Titre_2.setGeometry(QtCore.QRect(380, 525, 196, 71))
        font = QtGui.QFont()
        ...
        self.label_IconStatus_WIPEMAP.setGeometry(QtCore.QRect(35, 535, 51, 46))
        ...
        self.commandLinkButton_STEAM.setGeometry(QtCore.QRect(20, 110, 581, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        font.setBold(True)
