...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        self.label_Danger.setGeometry(QRect(295, 640, 51, 46))
        ...
        self.label_Titre_2.setGeometry(QRect(360, 630, 226, 71))
        font6 = QFont()
        ...
        self.commandLinkButton_STEAM.setGeometry(QRect(15, 110, 581, 51))
        font8 = QFont()
        ...
        self.checkBox_DebugMode.setGeometry(QRect(461, 70, 130, 20))
        ...
        self.radioButton_EFKStandard.setGeometry(QRect(65, 40, 281, 20))
        ...
        self.radioButton_EFKEnhanced.setGeometry(QRect(65, 20, 281, 20))
        ...
        self.radioButton_EFKNoModif.setGeometry(QRect(65, 60, 281, 20))
        ...
        self.label_SignAlert.setGeometry(QRect(343, 19, 21, 51))
        ...
        self.radioButton_Korean = QRadioButton(self.groupBox)
        self.radioButton_Korean.setObjectName(u"radioButton_Korean")
        self.radioButton_Korean.setGeometry(QRect(10, 70, 61, 26))
        icon12 = QIcon()
        icon12.addFile(u":/gfx/gfx/korean.png", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_Korean.setIcon(icon12)
        self.radioButton_Korean.setIconSize(QSize(34, 34))
        self.radioButton_Russian = QRadioButton(self.groupBox)
        self.radioButton_Russian.setObjectName(u"radioButton_Russian")
        self.radioButton_Russian.setGeometry(QRect(69, 69, 61, 26))
        icon13 = QIcon()
        icon13.addFile(u":/gfx/gfx/russe.png", QSize(), QIcon.Normal, QIcon.Off)
        self.radioButton_Russian.setIcon(icon13)
        self.radioButton_Russian.setIconSize(QSize(34, 34))
        ...
        icon14 = QIcon()
        icon14.addFile(u":/gfx/gfx/danger.png", QSize(), QIcon.Normal, QIcon.Off)
        self.checkBox_unlock.setIcon(icon14)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.radioButton_English.setToolTip(QCoreApplication.translate("Fenetre_Principale", u"English", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.radioButton_Korean.setToolTip(QCoreApplication.translate("Fenetre_Principale", u"Korean", None))
#endif // QT_CONFIG(tooltip)
        self.radioButton_Korean.setText("")
#if QT_CONFIG(tooltip)
        self.radioButton_Russian.setToolTip(QCoreApplication.translate("Fenetre_Principale", u"Russian", None))
#endif // QT_CONFIG(tooltip)
        self.radioButton_Russian.setText("")
