...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        self.pushButton_UninstallEFK.setGeometry(QtCore.QRect(135, 155, 296, 61))
        font = QtGui.QFont()
        ...
        self.radioButton_France.setGeometry(QtCore.QRect(330, 25, 106, 26))
        icon2 = QtGui.QIcon()
        ...
        self.radioButton_English.setGeometry(QtCore.QRect(330, 55, 96, 26))
        icon3 = QtGui.QIcon()
        ...
        self.groupBox_EFKEnhanced.setGeometry(QtCore.QRect(10, 305, 581, 71))
        ...
        self.radioButton_EFKStandard.setGeometry(QtCore.QRect(350, 30, 216, 20))
        ...
        self.radioButton_EFKEnhanced.setGeometry(QtCore.QRect(105, 30, 216, 20))
        ...
        self.label_CPULogo.setGeometry(QtCore.QRect(25, 15, 61, 51))
        self.label_CPULogo.setText("")
        self.label_CPULogo.setPixmap(QtGui.QPixmap(":/gfx/gfx/CPU.png"))
    ...
    def retranslateUi(self, Fenetre_Principale):
        ...
        self.radioButton_France.setText(_translate("Fenetre_Principale", "Francais"))
        self.radioButton_English.setToolTip(_translate("Fenetre_Principale", "English"))
        self.radioButton_English.setText(_translate("Fenetre_Principale", "English"))
