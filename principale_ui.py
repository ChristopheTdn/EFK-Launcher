...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        Fenetre_Principale.setEnabled(True)
        Fenetre_Principale.resize(605, 600)
        Fenetre_Principale.setMinimumSize(QSize(605, 600))
        Fenetre_Principale.setMaximumSize(QSize(605, 600))
        Fenetre_Principale.setBaseSize(QSize(605, 760))
        font = QFont()
        font.setPointSize(10)
        Fenetre_Principale.setFont(font)
        icon = QIcon()
        icon.addFile(u":/gfx/gfx/EFK.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.tabWidget_FenetrePrincipale.setGeometry(QRect(11, 332, 576, 256))
        ...
        icon1 = QIcon()
        icon1.addFile(u":/gfx/gfx/update.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.label_noConnexion.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_UpdateAvailable.setTextFormat(Qt.TextFormat.RichText)
        self.label_UpdateAvailable.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/gfx/gfx/skull.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.label_3.setGeometry(QRect(42, 101, 54, 16))
        self.label_8 = QLabel(self.tab_2)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(37, 120, 41, 16))
        self.label_9 = QLabel(self.tab_2)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(6, 141, 71, 16))
        self.label_10 = QLabel(self.tab_2)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(79, 101, 181, 16))
        self.label_10.setText(u"<html><head/><body><p><span style=\" font-weight:700;\">Tancred Terror</span></p></body></html>")
        self.label_11 = QLabel(self.tab_2)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(81, 121, 101, 16))
        ...
        self.label_12.setGeometry(QRect(82, 139, 187, 50))
        self.label_12.setText(u"<html><head/><body><p><span style=\" font-size:8pt; font-weight:700;\">MrGToF </span><span style=\" font-size:8pt;\">(fr,en)</span><span style=\" font-size:8pt; font-weight:700;\">, screamff </span><span style=\" font-size:8pt;\">(cn)<br/></span><a name=\"message-username-1185756075388063835\"/><span style=\" font-family:'inherit'; font-size:8pt; font-weight:700; color:#000000;\">E</span><span style=\" font-size:8pt; font-weight:700; color:#000000;\">lPacsWTF </span><span style=\" font-size:8pt;\">(es) </span><a name=\"message-username-1193274896193695815\"/><span style=\" font-family:'inherit'; font-size:8pt; font-weight:700; color:#000000;\">t</span><span style=\" font-size:8pt; font-weight:700; color:#000000;\">3qquq</span><span style=\" font-size:8pt;\">(ko)<br/></span><span style=\" font-size:8pt; font-weight:700;\">Shishail</span><span style=\" font-size:8pt;\"> (ru)</span></p></body></html>")
        self.label_13 = QLabel(self.tab_2)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(9, 204, 91, 16))
        self.label_15 = QLabel(self.tab_2)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(26, 184, 91, 16))
        ...
        self.label_18.setGeometry(QRect(4, 64, 51, 31))
        ...
        self.label_19.setGeometry(QRect(64, 63, 201, 36))
        ...
        self.label_20.setGeometry(QRect(50, 10, 211, 51))
        ...
        self.label_22.setGeometry(QRect(60, 105, 189, 36))
        self.label_22.setText(u"<html><head/><body><p>2023-2024 EFK Launcher<br/><span style=\" font-size:9pt;\">Licence GNU AGPLv3</span></p></body></html>")
        self.label_AboutGithub = QLabel(self.tab_2)
        self.label_AboutGithub.setObjectName(u"label_AboutGithub")
        self.label_AboutGithub.setGeometry(QRect(101, 205, 46, 16))
        ...
        self.label_AboutDiscord.setGeometry(QRect(82, 181, 76, 26))
        ...
        self.lineEdit_RepertoireSaveGame.setGeometry(QRect(94, 47, 405, 21))
        self.lineEdit_RepertoireSaveGame.setFont(font4)
        self.lineEdit_RepertoireSaveGame.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_IconStatus_ProfilPZ.setGeometry(QRect(513, 17, 31, 31))
        ...
        self.label_4.setGeometry(QRect(9, 22, 81, 20))
        self.label_4.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        self.label_5 = QLabel(self.groupBox_UserDir)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(9, 47, 81, 20))
        ...
        self.commandLinkButton_Twitch.setFont(font5)
        self.commandLinkButton_Twitch.setText(u"")
        icon3 = QIcon()
        icon3.addFile(u":/gfx/gfx/Twitch-logo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.commandLinkButton_Youtube.setFont(font5)
        self.commandLinkButton_Youtube.setText(u"")
        icon4 = QIcon()
        icon4.addFile(u":/gfx/gfx/youtube.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.commandLinkButton_Discord.setFont(font5)
        self.commandLinkButton_Discord.setText(u"")
        icon5 = QIcon()
        icon5.addFile(u":/gfx/gfx/discord.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.pushButton_RunPZ.setGeometry(QRect(445, 20, 153, 46))
        font7 = QFont()
        font7.setPointSize(12)
        font7.setBold(True)
        self.pushButton_RunPZ.setFont(font7)
        icon7 = QIcon()
        icon7.addFile(u":/gfx/gfx/pz.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.radioButton_EFKEnhanced.setGeometry(QRect(68, 22, 281, 20))
        ...
        self.label_CPULogo.setGeometry(QRect(10, 20, 51, 51))
        ...
        self.radioButton_EFKNoModif.setGeometry(QRect(67, 44, 281, 20))
        ...
        self.label_UpdateAvailable_2.setTextFormat(Qt.TextFormat.RichText)
        self.label_UpdateAvailable_2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/gfx/gfx/france.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboBox_Translate.addItem(icon8, "")
        icon9 = QIcon()
        icon9.addFile(u":/gfx/gfx/chine.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboBox_Translate.addItem(icon9, "")
        icon10 = QIcon()
        icon10.addFile(u":/gfx/gfx/royaumeunis.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboBox_Translate.addItem(icon10, "")
        icon11 = QIcon()
        icon11.addFile(u":/gfx/gfx/korean.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboBox_Translate.addItem(icon11, "")
        icon12 = QIcon()
        icon12.addFile(u":/gfx/gfx/russe.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboBox_Translate.addItem(icon12, "")
        icon13 = QIcon()
        icon13.addFile(u":/gfx/gfx/espagne.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.comboBox_Translate.addItem(icon13, "")
        ...
        self.groupBox_UserDir.raise_()
        self.label_Titre.raise_()
        self.label_2.raise_()
        self.commandLinkButton_Twitch.raise_()
        self.commandLinkButton_Youtube.raise_()
        self.commandLinkButton_Discord.raise_()
        self.pushButton_RunPZ.raise_()
        self.checkBox_DebugMode.raise_()
        self.groupBox_EFKEnhanced.raise_()
        self.label_version.raise_()
        self.label_UpdateAvailable_2.raise_()
        self.groupBox_langage.raise_()
        self.label_TooltipSteamCollection.raise_()
    ...
    def retranslateUi(self, Fenetre_Principale):
        ...
        self.comboBox_Translate.setItemText(3, QCoreApplication.translate("Fenetre_Principale", u"Korean", None))
        ...
        self.label_TooltipSteamCollection.setText(QCoreApplication.translate("Fenetre_Principale", u"<html><head/><body><p><span style=\" font-size:8pt; font-weight:700; color:#aa0000;\">IMPORTANT : </span><span style=\" font-size:8pt; font-style:italic; color:#000000;\">Subscribing to this collection </span><span style=\" font-size:8pt; font-style:italic; text-decoration: underline; color:#000000;\">is a must to play EFK.</span></p></body></html>", None))
    # retranslateUi
