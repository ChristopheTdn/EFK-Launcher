...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        icon9 = QIcon()
        icon9.addFile(u":/gfx/gfx/chine.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_Translate.addItem(icon9, "")
        icon10 = QIcon()
        icon10.addFile(u":/gfx/gfx/royaumeunis.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_Translate.addItem(icon10, "")
        icon11 = QIcon()
        icon11.addFile(u":/gfx/gfx/korean.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_Translate.addItem(icon11, "")
        icon12 = QIcon()
        icon12.addFile(u":/gfx/gfx/russe.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_Translate.addItem(icon12, "")
        icon13 = QIcon()
        icon13.addFile(u":/gfx/gfx/espagne.png", QSize(), QIcon.Normal, QIcon.Off)
