...
class Ui_Fenetre_Principale(object):
    def setupUi(self, Fenetre_Principale):
        ...
        self.pushButton_MajEFK = QtWidgets.QPushButton(parent=self.tab_deleteEFK)
        self.pushButton_MajEFK.setEnabled(True)
        self.pushButton_MajEFK.setGeometry(QtCore.QRect(195, 30, 201, 36))
    ...
    def retranslateUi(self, Fenetre_Principale):
        ...
        self.pushButton_MajEFK.setText(_translate("Fenetre_Principale", "Maj EFK"))
